...
hadd -f results/datasets_trees/dibosons_ll.root results/datasets_trees/dibosons_Ele.root results/datasets_trees/dibosons_Mu.root 
hadd -f results/datasets_trees/others_ll.root results/datasets_trees/others_Ele.root results/datasets_trees/others_Mu.root 
